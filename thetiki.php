...
<head>
  <title>Υπολογισμός Μορίων Θετικής 2023</title>
...
<h2>2ο Επιστημονικό Πεδίο</h2>
<b>Έκθεση-Μαθηματικά-Φυσική-Χημεία</b>
...
$('input').keyup(function(){ // run anytime the value changes
    ...
    var totgr = (((glang * clang)+(gmath*cmath)+(gphys*cphys)+(gchem*cchem))*1000)/4
